...
4. **เอนจินประเมินผลกลยุทธ์**: สร้างระบบวิเคราะห์โอกาสแบบผสมผสาน (Composite Opportunity Score - COS) เพื่อให้คะแนน ตัดสิน จัดอันดับ และออกรายงานความเหมาะสมของเหรียญต่างๆ สำหรับกลยุทธ์การเทรดขั้นสูง`,
        ...
        image: 'https://placehold.co/800x450/313131/FFFFFF?text=Market+Scanner',
        images: [
            {
                url: 'https://placehold.co/800x450/313131/FFFFFF?text=Market+Scanner',
...
4. **การจัดเก็บข้อมูลเชิงลึก**: เชื่อมต่อกับ Supabase เพื่อบันทึกข้อมูลการเทรดอย่างละเอียด รวมถึงค่าความหน่วงของ API (Latency) และประสิทธิภาพของแต่ละกลยุทธ์เพื่อการพัฒนาอย่างต่อเนื่อง`,
        ...
        image: 'https://placehold.co/800x450/313131/FFFFFF?text=Futures+Scalping',
        images: [
            { url: 'https://placehold.co/800x450/313131/FFFFFF?text=Multi-Engine+System', caption: { en: '', th: 'ระบบประมวลผล Multi-Engine' } },
            { url: 'https://placehold.co/800x450/313131/FFFFFF?text=Futures+Scalping', caption: { en: '', th: 'ผลการ Scalping' }, isPrimary: true },
        ],
        link: '',
