            ...
            >
              ...
              >
                ...
                <div className="flex flex-1 flex-col justify-between w-full min-w-0">
                  <div>
                    <h3 className="line-clamp-1 text-base sm:text-lg font-bold text-gray-900 dark:text-gray-100">
            ...
            >
              ...
              >
                ...
                <div className="flex flex-1 flex-col justify-between p-3.5 sm:p-4">
                  <div>
                    <h3 className="line-clamp-1 text-sm font-bold leading-snug text-gray-900 dark:text-gray-100">
                      {getLocalized(project.title)}
                    </h3>
                  ...
                  <div className="mt-3.5 flex items-center justify-between pt-0.5">
                    ...
                    <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-teal-600 dark:text-teal-400 shrink-0">
                      {t('portfolio.viewProject')}
